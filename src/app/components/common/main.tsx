...
export default function Banner() {
  return (
    <div className="border rounded-2xl my-16 py-16 bg-gradient-to-r from-gray-900 via-black to-gray-900 max-h-[500px] flex flex-col md:flex-row items-center justify-center">
      {/* Left: Image Section */}
      <div className="relative w-full md:w-1/2 flex justify-center items-center">
        <Image
